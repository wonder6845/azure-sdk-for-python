...
class KeyReleasePolicy(object):
    ...
    def __init__(self: bytes, encoded_policy, **kwargs) -> None:
...
class KeyRotationLifetimeAction(object):
    ...
    def __init__(self, action: KeyRotationPolicyAction, **kwargs) -> None:
        self.action = action
...
class KeyVaultKey(object):
    ...
    def __init__(self, key_id: str, jwk: Optional[dict]=None, **kwargs:Any) -> None:
